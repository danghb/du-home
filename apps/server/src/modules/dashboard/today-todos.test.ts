...
describe('selectTodayTodos', () => {
  it('keeps date-only values in the family calendar timezone', () => {
    const items: TodoItem[] = [
      { id: 'date', summary: '纯日期事项', due: { kind: 'date', value: '2026-08-12' }, completed: false },
      { id: 'late', summary: '今晚事项', due: { kind: 'datetime', value: '2026-08-12T20:00:00+08:00' }, completed: false },
      { id: 'yesterday', summary: '昨天事项', due: { kind: 'date', value: '2026-08-11' }, completed: false },
      { id: 'done', summary: '已完成事项', due: { kind: 'date', value: '2026-08-12' }, completed: true },
    ];
